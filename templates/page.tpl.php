<div id="wrap">
    <div class="container">
        ...
        <div id="header" class="sixteen columns clearfix">
            <div class="menu-top">
                <ul>
                    <li><a class="drop" href="#"><span>Login</span></a>
                        <ul>
                            <li>
                    ...
                    <li><a href="#" class="drop"><span>Debian.org</span></a>
                        <ul>
                            <li><a href="http://debian.org">Home</a></li>
                            <li><a href="http://wiki.debian.org">Wiki</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
            <div class="inner one_third">
                <?php if ($logo): ?>
            ...
            <div class="two_thirds last">
                <?php if ($page['search_page']): ?><?php print render($page['search_page']); ?><?php endif; ?>
            </div>
